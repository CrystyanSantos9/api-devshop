...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.create = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.categoryRepository.save(input)];
            });
        });
    };
    CategoryService.prototype.update = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryRepository.update(input.id, {
                            name: input.name,
                            slug: input.slug
                        })];
                    case 1:
...
//# sourceMappingURL=category.servcice.js.map